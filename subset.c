...
//return a subset containing a point per community, with the communites in random order
...
//return a point per community subset with communities in descending order relative to their sizes
